...
<body>
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<h4>Nível:</h4>
			<p>
				<c:if test="${usuario.nivel ==1 }">Básico</c:if>
				<c:if test="${usuario.nivel ==2 }">Intermediário</c:if>
				<c:if test="${usuario.nivel ==3 }">Avançado</c:if>
			</p>			
			<hr/>
			
			<a href="/admin/user/edit?id=${usuario.id}"><button type="button" class="btn btn-primary">Editar</button></a>
			</div>
		</div>
